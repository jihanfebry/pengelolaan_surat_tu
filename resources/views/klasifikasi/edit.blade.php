...
<a href="{{ route('klasifikasi.data') }}" class="btn btn-secondary" style="float: right; width: 100px; margin-top: -2rem;">Kembali</a><br><br>

    <form action="{{ route('klasifikasi.update', $letter_type['id']) }}" class="container bg-light p-5 " method="post">
        @csrf
        @method('PATCH')
        @if ($errors->any())
