...
<div class="container bg-light p-5">
    ...
    @endif
        <div class="mb-4">
            <a href="{{ route('klasifikasi.create') }}" class="btn btn-primary" style="float: right">Tambah</a>
            <a href="{{ route('klasifikasi.download-excel') }}" class="btn btn-info text-white" style="margin-left: 590px">Export Klasifikasi Surat</a>
            <form action="{{ route('klasifikasi.search') }}" style="float: left" class="d-flex" method="GET">
       ...
       <table class="table mt-3 table-striped table-bordered table-hovered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="d-flex">
                    <a href="{{ route('klasifikasi.detail', $item['id']) }}" class="nav-link mt-1 text-primary" style="margin-right: 5px;">Lihat</a>
                    <a href="{{ route('klasifikasi.edit', $item['id']) }}" class="btn btn-primary" style="margin-right: 5px;">Edit</a>
