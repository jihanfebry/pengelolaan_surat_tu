...
<div class="container bg-light p-5">
    ...
    @endif
        ...
        <a href="{{ route('dataSurat.create') }}" class="btn btn-primary">Tambah</a>
        <a href="{{ route('dataSurat.download-excel') }}" class="btn btn-info text-white">Export Data Surat</a>
        <form action="{{ route('dataSurat.search') }}" style="float: right" class="d-flex" method="GET">
       ...
       <table class="table mt-3 table-striped table-bordered table-hovered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex">
                        <a href="{{ route('dataSurat.show', $item['id']) }}" class="nav-link mt-2 text-primary" style="margin-right: 5px;">Lihat</a>
                        <a href="{{ route('dataSurat.edit', $item['id']) }}" class="btn btn-primary" style="margin-right: 5px;">Edit</a>
