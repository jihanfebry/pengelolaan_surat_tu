...
@section('content')
    ...
    @if (Auth::user()->role == 'staff')
            ...
            <div class="container bg-light p-5">
                ...
                <a href="{{ route('dataSurat.download-excel') }}" class="btn btn-info text-white">Eksport Surat</a>
                    ...
                    <tbody>
                        @foreach ($letters as $item)
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a href="{{ route('dataSurat.show', $item['id']) }}"
                                            class="nav-link mt-2 text-primary" style="margin-right: 5px;">Lihat</a>
                                        <a href="{{ route('dataSurat.edit', $item['id']) }}" class="btn btn-primary"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form action="{{ route('dataSurat.delete', $item['id']) }}"
                                                            method="post">
                                                            @csrf
                                                            @method('DELETE')
